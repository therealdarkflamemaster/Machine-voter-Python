# BlowFish is used for encrypting the communication between users and the servers
...
def input_string(message):
    ...
    for letter in message:
        ...
        encrypt.append(encrypted_data)

    return encrypt


def return_string(encrypt):
    decrypted = []
    for encrypted_data in encrypt:
        decrypted_data = decryption(encrypted_data)
        decrypted.append(chr(decrypted_data))
